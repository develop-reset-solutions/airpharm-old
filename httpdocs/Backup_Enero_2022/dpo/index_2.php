    ...
    <div class="filtros">
      <form method="post" action="#">
        ...
        <tr>
          ...
          <td class="texto_10"><input type="button" onClick="window.open('imprimir_dpo_consecucion.php?dpo_id=<?php echo $row['dpo_id'];?>','_newtab')" value="Imprimir consecución" class="texto_10" ></td>
          ...
          <td style="background-color:#999999; width:300px;"></td>
          <td class="texto_10"> Colaborador:
            <select name="dpo_usr_id" id="dpo_usr_id" class="texto_10">
              <option value="<?php echo $row['usr_id'];?>"><?php echo utf8_encode($row['usr_apellidos'].", ".$row['usr_nombre']);?></option>
              <?php 
          ...
          <td class="texto_10"> Año:
            <select name="dpo_ano" class="texto_10">
              <?php for($i=2014;$i<=date('Y');$i++){?>
              <option value="<?php echo $i;?>"<?php if($i==$dpo_ano){?> selected="selected"<?php }?>><?php echo $i;?></option>
              <?php }?>
            </select></td>
    ...
    <table width="100%">
      <form action="modify.php" method="post" enctype="multipart/form-data">
		...
		$n=1;
          ...
          <td class="numerica celdas_subtotal celdas_peso"><?php echo number_format($row_lin['dl_peso'],1,',','.');?></td>
          <td class="titulo_grupo"></td>
          <td class="numerica celdas_subtotal"><?php if(utf8_encode($row_lin['obj_tipo'])=='Objetivo de Compañía' or utf8_encode($row['obj_tipo'])=='Proyecto' or utf8_encode($row['obj_tipo'])=='Para el Comité de Dirección'){?>
            G
            <?php }else{?>
            I
            <?php }?></td>
          ...
          <td class="numerica celdas_subtotal"><?php echo number_format(sim_anual($row_lin['dl_id']),2,',','.');$total_por_sim+=sim_anual($row_lin['dl_id']);?></td>
          <td class="numerica celdas_subtotal"><?php echo number_format((por_obtencion($row_lin['dl_id'])*$valor_sim)/100,2,',','.').'€';$total_sim+=por_obtencion($row_lin['dl_id'])*$valor_sim/100;?></td>
        </tr>
        <?php }?>
        <tr>
          <td colspan="20"></td>
		...
		$num_ooe=mysql_num_rows($result_ooe);
          ...
          <td class="numerica celdas_subtotal"><?php echo number_format($row_lin['oa_horquilla_min'],2,',','.');?></td>
          <td class="numerica celdas_subtotal"><?php echo number_format($row_lin['oa_horquilla_max'],2,',','.');?></td>
          <td class="numerica celdas_subtotal celdas_peso"><?php echo number_format($row_lin['dl_peso'],2,',','.');?></td>
          <td class="titulo_grupo"></td>
          <td class="numerica celdas_subtotal"><?php if(utf8_encode($row_lin['obj_tipo'])=='Objetivo de Compañía' or utf8_encode($row['obj_tipo'])=='Proyecto' or utf8_encode($row['obj_tipo'])=='Para el Comité de Dirección'){?>
            G
            <?php }else{?>
...
?>
        ...
        <tr class="titulo_grupo">
          ...
          <td class="numerica"><?php echo number_format($total_por_sim,2,',','.');?>%</td>
          <td class="numerica"><?php echo number_format($total_sim,2,',','.');?>€</td>
        </tr>
        <tr>
          <td colspan="20" class="filas_subtotal" align="center"><input type="submit" name="Guardar" id="Guardar" value="Guardar DPO" />
            &nbsp;&nbsp;
      ...
      <tr class="filas_subtotal">
        <td colspan="20"><table width="100%">
            <tr>
              <td colspan="3"  class="titulo_grupo">Enero-Marzo</td>
            </tr>
            <tr class="titulo_dpo">
              <td>Nº LINEA</td>
              <td>COMENTARIO</td>
	  ...
	  while($row_com=mysql_fetch_array($result_com)){?>
            ...
            <tr>
              <td colspan="3"  class="titulo_grupo">Abril-Junio</td>
            </tr>
            <tr class="titulo_dpo">
              <td>Nº LINEA</td>
              <td>COMENTARIO</td>
	  ...
	  while($row_com=mysql_fetch_array($result_com)){?>
            ...
            <tr>
              <td colspan="3"  class="titulo_grupo">Julio-Septiembre</td>
            </tr>
            <tr class="titulo_dpo">
              <td>Nº LINEA</td>
              <td>COMENTARIO</td>
	  ...
	  while($row_com=mysql_fetch_array($result_com)){?>
            ...
            <tr>
              <td colspan="3"  class="titulo_grupo">Octubre-Diciembre</td>
            </tr>
            <tr class="titulo_dpo">
              <td>Nº LINEA</td>
              <td>COMENTARIO</td>
	  ...
	  while($row_com=mysql_fetch_array($result_com)){?>
            ...
            <tr>
              <td colspan="3"  class="titulo_grupo">Conclusiones Anuales</td>
            </tr>
            <tr class="titulo_dpo">
              <td>Nº LINEA</td>
              <td>COMENTARIO</td>
