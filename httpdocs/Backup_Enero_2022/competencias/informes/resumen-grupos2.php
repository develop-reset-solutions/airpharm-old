...
<div id="content">
  <div style="width:100%;">
    <center>
      <form name="desaso" action="imprimir_todos2.php" method="post" style="text-align:-moz-center;">
        <table align="center" width="100%" class="tabla_introduccion">
        <tr>
          <td colspan="2" class="titulo negrita">IMPRIMIR COMPETENCIAS - SELECCIONAR USUARIOS</td>
        </tr>
        <tr>
					...
					<select name="usr_id" id="usr_id" >
						...
						<?php if($_SESSION['usr_perfil']=='Director General' or $_SESSION['usr_perfil']=='Administrador' or $_SESSION['usr_perfil']=='Director RRHH'){
									...
									while($row_usr=mysql_fetch_array($result_usr)){
										$query_dpo="SELECT * FROM  vcom_diccionarios_usuarios WHERE du_usr_id=".$row_usr['usr_id']." AND dic_ano=".$dic_ano;
