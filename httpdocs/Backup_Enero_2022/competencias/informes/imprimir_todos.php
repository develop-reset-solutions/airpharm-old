...
//$usr_id=$_REQUEST['usr_id'];
	  ...
	  if ($_SESSION['usr_perfil']=='Director RRHH'){
		if($usr_id=='all'){
			$query_usr_dic="SELECT * FROM vcom_diccionarios_usuarios WHERE dic_ano=".$_SESSION['ano']." ORDER BY apellidos ASC, nombre ASC";
			...
			$query_usr_dic="SELECT * FROM vcom_diccionarios_usuarios WHERE usr_cen_id=".$cen_id." AND dic_ano=".$_SESSION['ano']." ORDER BY apellidos ASC, nombre ASC";
			...
			$query_usr_dic="SELECT * FROM vcom_diccionarios_usuarios WHERE usr_dep_id=".$dep_id." AND dic_ano=".$_SESSION['ano']." ORDER BY apellidos ASC, nombre ASC";
			$result_usr_dic=mysql_query($query_usr_dic) or die ("No se puede ejecutar la sentencia: ".$query_usr_dic);
		}else{
			$query_usr_dic="SELECT * FROM vcom_diccionarios_usuarios WHERE du_usr_id=".$usr_id." AND dic_ano=".$_SESSION['ano'];
			$result_usr_dic=mysql_query($query_usr_dic) or die ("No se puede ejecutar la sentencia: ".$query_usr_dic);
		}
