...
$query_usr1="SELECT * FROM usuarios ";
...
$query.=" ORDER BY usr_apellidos, usr_nombre ASC";
...
<div id="content">
       ...
       <div class="filtros">
          <form method="post" action="#">
            ...
            <tr>
                ...
                <td><a target="blank" href="imprimir_todos_new.php" class="texto_10">Imprimir Todos</a>
                </td>
   ...
   <div class="tabla_apartados">
    <table width="100%">
      <thead>
	    	<td width="36%">Colaborador</td>
            <td width="36%">Diccionario</td>
            <td width="8%">Fecha Cierre</td>
            <?php if ($_SESSION['usr_perfil']=='Director RRHH'){?>
				<td width="10%">Acción</td>
				<td width="10%">Validar/Rechazar</td>
            <?php } else { ?>
	  ...
	  if ($_SESSION['usr_perfil']=='Director RRHH'){
		...
		while($row_usr_dic=mysql_fetch_array($result_usr_dic)){
            ...
            <tr class="filas_subtotal">
                     ...
                     <!--<td><?php echo cambiaf_a_normal($row_vdic['du_fecha_cierre']);?></td>-->
                     <td><?php if ($row_vdic['du_fecha_cierre']!=""){?><input class="campo-corto" id="fecha_cierre" name="fecha_cierre" value="<?php echo cambiaf_a_normal($row_vdic['du_fecha_cierre']);?>" ><?php } ?></td>
                    ...
                    <td class="subtitulo"><input type="radio" name="cierre" value="Aceptar"></input> / <input type="radio" name="cierre" value="Rechazar"></input></td>
      			</tr>
	...
	//if ( $row_vdic['dic_id']!=""){
      ...
      <tr class="filas_subtotal">
             ...
             <td><?php echo utf8_encode($row_vdic['dic_nombre']);?></td>
             <td><?php if ($row_vdic['du_fecha_cierre']!=""){echo cambiaf_a_normal($row_vdic['du_fecha_cierre']);}?></td>
