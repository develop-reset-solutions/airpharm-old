...
$("#Guardar").click(function (){
		if($("#grado").val() == "0" && document.getElementById('grado').disabled == false){ 
        	alert("Tienes que introducir el valor del grado."); 
            return false;
    	}
		
  	});
$("#Guardar-seguir").click(function (){
		if($("#grado").val() == "0" && document.getElementById('grado').disabled == false){ 
        	alert("Tienes que introducir el valor del grado."); 
            return false;
    	}
...
$(".Guardar").click(function (){
		if(($("#grado").val() == "0" || $("#grado").val() == null) && document.getElementById('grado').disabled == false){ 
			...
			alert("grado: "+$("#grado").val()+" disabled: "+document.getElementById('grado').disabled ); 
		}*/
...
*/
	...
	/* desactivo la obligatoriedad de rellenar los campos completos
		var j = 0;
		var completo=true;
		while (j < 3) {
			j ++;
			...
			while (i < 4) {
				i++
				comp=document.getElementById("comp_"+j+"_"+i).value;
				document.getElementById("comp_"+j+"_"+i).value=comp;
				//$("#comp_"+j+"_"+i").val($(this).val());
				if (comp==0){
					completo=false;
				}
			}
          ...
          <td class="texto_10">
            ...
            <td style="background-color:#999999;"><?php 
				  ...
				  if ($com_id_ant){
					  $col++;
				  	?>
                    <a href="edit.php?com_id=<?php echo $com_id_ant;?>&amp;usr_id=<?php echo $usr_id;?>"><img src="../../img/atras.png" width="25" height="25" ></a>
                     <?php }
				  if ($com_id_sig){
					  $col++;
				  	?>
                    
                   <a href="edit.php?com_id=<?php echo $com_id_sig;?>&amp;usr_id=<?php echo $usr_id;?>"><img src="../../img/adelante.png" width="25" height="25"></a>
      ...
      <tr class="filas_subtotal">
        ...
        <td>
			...
			//if($row['du_usr_id']!=""){
				...
				// esta calcualando mal $du_id_ant 
			...
			*/
            ...
            <input type="hidden"  value="<?php echo $ano_ant; ?>"/>
