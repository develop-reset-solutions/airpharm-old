...
<div id="content">
  <div style="width:100%;">
    <center>
      <form name="desaso" action="../informes/competencias-excel.php" method="post" style="text-align:-moz-center;">
        <table align="center" width="100%" class="tabla_introduccion">
        <tr>
          <td colspan="2" class="titulo negrita">IMPRIMIR COMPETENCIAS A EXCEL - SELECCIONAR USUARIOS</td>
        </tr>
        <tr>
              ...
              <tr>
                <td align="center" colspan="4">
					<select name="usr_id" id="usr_id">
						...
						<optgroup label="Departamentos" value="departamento">
					...
					<!-- Nuevo Input Select -->
					<?php
						$sql = "SELECT DISTINCT dic_ano FROM vcom_diccionarios_usuarios ORDER BY dic_ano DESC";
						$result = mysql_query($sql);
						
						echo "<select name='ejercicio' id='ejercicio'>";
							while ($row = mysql_fetch_array($result)) {
								echo "<option value='".$row['dic_ano']."'>".$row['dic_ano']."</option>";
							}
						echo "</select>";
					?>
