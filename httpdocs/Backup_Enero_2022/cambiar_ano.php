...
<center>   <form action="modify.php" method="post" onSubmit="return Valida(this);" style="text-align:-moz-center;">
    <table align="center" class="tabla_introduccion">
     ...
     <tr>
        <td colspan="4" align="center"><input type="submit" value="Seleccionar" class="boton-crear">&nbsp;<input type="button" value="Volver a inicio" class="boton-crear" onClick="document.location.href = 'home.php'"></td>
      </tr>
    </table>
  </form></center>  </div>
