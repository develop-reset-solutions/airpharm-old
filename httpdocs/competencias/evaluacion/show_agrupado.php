          ...
          <td class="texto_10">
            ...
            <td style="background-color:#999999;"><?php 
				  ...
				  if ($com_id_ant){
					  $col++;
				  	?>
                    <a href="show_agrupado.php?com_id=<?php echo $com_id_ant;?>&amp;usr_id=<?php echo $usr_id;?>"><img src="../../img/atras.png" width="25" height="25" ></a>
                     <?php }
				  if ($com_id_sig){
					  $col++;
				  	?>
                    
                   <a href="show_agrupado.php?com_id=<?php echo $com_id_sig;?>&amp;usr_id=<?php echo $usr_id;?>"><img src="../../img/adelante.png" width="25" height="25"></a>
      ...
      */
      ...
      <tr>
        <td colspan="3" class="filas_subtotal" align="center">
          <input type="button" value="Salir" onclick="salir()" /></td>
      </tr>
    </table>
