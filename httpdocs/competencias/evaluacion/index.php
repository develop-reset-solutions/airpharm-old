   ...
   <div class="tabla_apartados">
	  ...
	  if ($_SESSION['usr_perfil']=='Director RRHH'){
		...
		while($row_usr_dic=mysql_fetch_array($result_usr_dic)){
            ...
            <tr class="filas_subtotal">
                     ...
                     <?php } else { ?>
                        <img src="/img/abrir.png" width="15" height="15" alt="Abrir" title="Abrir">
						<a href="edit_libre.php?usr_id=<?php echo $row_vdic['du_usr_id'];?>">
               			<img src="/img/llave.png" width="15" height="15" alt="Editar" title="Editar"></a>&nbsp;
                     <?php }?>
                     </td>
                    ...
                    <td class="numerica">
                      ...
                      <?php }
                    	...
                    	<?php } */
                         if ($_SESSION['usr_perfil']=='Director RRHH'){
							  ?> 
							 <a href="delete_diccionario.php?du_id=<?php echo $row_vdic['du_id'];?>">
                             <img src="/img/borrar.png" width="15" height="15" alt="Eliminar" title="Eliminar"></a>
	...
	if ( $row_vdic['dic_id']!=""){
	  ...
	  while($row_usr1=mysql_fetch_array($result_usr1)){
		...
		if($row_usr1['usr_id']!=$_SESSION['usr_id']){
