...
<center>
    <table align="center" class="tabla_introduccion">
      ...
      <tr>
        <td colspan="4" align="center"><input type="button" value="Cambiar contraseña" class="boton-crear" onClick="document.location.href = 'edit-pass.php'">&nbsp;<input type="button" value="Volver" class="boton-crear" onClick="document.location.href = '/competencias/'"></td>
      </tr>
    </table>
</center>
  </div>
