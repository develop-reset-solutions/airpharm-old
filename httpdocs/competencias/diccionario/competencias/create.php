...
<script language="javascript">
	function cambiar_com_id(val){
		...
		window.location="insert.php?com_id="+val+"&dic_id="+dic_id+"&cd_orden="+cd_orden;

		}
		/*
	function ver(val){
		
		window.location="show.php?com_id="+val;
...
<div id="content">
  <div class="cabecera_apartados">
   ...
   <div class="tabla_apartados">
    <table width="100%">
      ...
      <?php
	  $query_ccd="SELECT * FROM com_com_dic WHERE cd_dic_id=".$dic_id." ORDER BY cd_orden";
	  ...
	  while($row_ccd=mysql_fetch_array($result_ccd)){?>
        ...
        <td class="numerica">
            ...
            <a href="delete.php?orden=<?php echo $row_ccd['cd_orden'];?>&dic_id=<?php echo $dic_id;?>"><img src="/img/borrar.png" width="20" height="20" alt="Borrar" title="Borrar"></a>-->
 ...
 <?php }?>
     ...
     <td>Añade otra competencia: <select class="select_normal" name="com_id" onchange="cambiar_com_id(this.value)">
  ...
  <center>
    ...
    <input type="button" value="Modificar Competencias" class="boton-crear" onClick="document.location.href = '../diccionario/show_c.php?$dic_id'">&nbsp;-->
  	<input type="button" value="Volver al Diccionario" class="boton-crear" onClick="document.location.href = '../show.php?dic_id=<?php echo $dic_id?>'">
  </center>
