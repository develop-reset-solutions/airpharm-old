...
*/
$nombre=utf8_encode($row['dic_nombre']).' ('.$row['dic_ano'].')';
?>
<link href="../../css/style.css" rel="stylesheet" type="text/css">
<div id="content">
<div style="width:100%;">
<center>   <form action="abierto.php?dic_id=<?php echo $dic_id;?>" method="post" onSubmit="return Valida(this);" style="text-align:-moz-center;">
    <table align="center" class="tabla_introduccion">
      <tr>
        <td colspan="2" class="titulo negrita">ABRIR DICCIONARIO</td>
      </tr>
      <tr>
