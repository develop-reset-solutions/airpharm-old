...
<div>
  <p style="max-width: 1000px;margin:0;padding:0;font-family:Helvetica, Arial;margin-bottom:10px;font-weight:300;color:#343641;font-size:15px;line-height:1.6;text-align: left;">
    Se ha generado una contraseña para ti, pero por motivos de seguridad, debes cambiarla. Para ello <a href="http://10.2.0.66" style=color:#2FB45A;font-size:17px;text-decoration:none;> inicia sesión </a> con tu correo electronico y la contraseña indicada al final y sigue los pasos que alli te indican.
  </p>
