...
if($_POST['filtrar']){
	...
	if($_POST['oa_status_id']<>'all'){
		$oa_status_id=$_POST['oa_status_id'];
		$query.=" AND oa_status_id =".$oa_status_id."";
	}
}elseif($_POST['reset']){
	$obj_descripcion='';
	$obj_tipo='all';
  ...
  <div class="cabecera_apartados">
    <div class="filtros">
      <form method="post" action="#">
        ...
        <tr>
        <td colspan="6">Objetivos 2016</td>
          <tr>
         <td><a href="../objetivos/create.php" class="texto_10">Añadir Objetivo</a>
        </td>
            <td class="texto_10"> Estado:
              <select name="oa_status_id" id="oa_status_id" class="texto_10">
...
<option value="<?php echo $row_st['sd_id'];?>"<?php if($oa_status_id==$row_st['sd_id']){?> selected<?php }?>><?php echo utf8_encode($row_st['sd_nombre']);?></option>
<?php }?>
              </select>
              </td>
...
<tr>      	<td width="27%">Objetivo</td>
	  ...
	  while($row=mysql_fetch_array($result)){?>
        ...
        <td class="numerica"><a href="show.php?oa_id=<?php echo $row['oa_id'];?>"><img src="/img/ver.png" width="20" height="20" alt="Ver detalles" title="Ver detalles"></a>&nbsp;<?php if($row['obj_lider_id']<>$_SESSION['usr_id']){?><a href="edit.php?oa_id=<?php echo $row['oa_id'];?>"><img src="/img/editar.png" width="20" height="20" alt="Editar" title="Editar"></a>&nbsp;<!--<a href="delete.php?oa_id=<?php echo $row['oa_id'];?>"><img src="/img/aceptar.png" width="20" height="20"></a>--><?php }?></td>
      </tr>
 <?php }?>
 	    </table>
  </div>
