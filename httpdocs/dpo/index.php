          ...
          <td class="texto_10"> Colaborador:
            <select name="dpo_usr_id" id="dpo_usr_id" class="texto_10">
              ...
              <?php }else{
						...
						while($superior<>'130' and $es_superior==true and $superior<>''){
      ...
      <form action="modify.php" method="post" enctype="multipart/form-data">
		...
		$n=1;
          ...
          <td class="numerica celdas_subtotal"><?php if(utf8_encode($row_lin['ind_grupo_individual'])=='Grupo'){?>
            ...
            <?php }?></td>
			<!-- T1 -->
          <td class="numerica celdas_subtotal">
            ...
            <?php }else{
						echo $row_lin['dl_rdo_q1'];}$total_q1+=por_obtencion($row_lin['dl_id'],1);?>
			</td>
			<!-- T2 -->
          <td class="numerica celdas_subtotal"><?php if($row_lin['ind_mide']==$_SESSION['usr_id'] or ($row_lin['ind_mide']==9999 and ($_SESSION['usr_id']<>$dpo_usr_id or utf8_encode($_SESSION['usr_categoria'])=='Dirección'))){
            ...
            <?php }else{ echo $row_lin['dl_rdo_q2'];}$total_q2+=por_obtencion($row_lin['dl_id'],2);?>
			</td>
			<!-- T3 -->
          <td class="numerica celdas_subtotal"><?php if($row_lin['ind_mide']==$_SESSION['usr_id'] or ($row_lin['ind_mide']==9999 and ($_SESSION['usr_id']<>$dpo_usr_id or utf8_encode($_SESSION['usr_categoria'])=='Dirección'))){?>
            <input class="campo-dpo" name="dl_rdo_q3_<?php echo $row_lin['dl_id'];?>" value="<?php echo $row_lin['dl_rdo_q3'];?>" />
            <?php }else{ echo $row_lin['dl_rdo_q3'];}$total_q3+=por_obtencion($row_lin['dl_id'],3);?>
			</td>
			<!-- T4 -->
          <td class="numerica celdas_subtotal"><?php if($row_lin['ind_mide']==$_SESSION['usr_id'] or ($row_lin['ind_mide']==9999 and ($_SESSION['usr_id']<>$dpo_usr_id or utf8_encode($_SESSION['usr_categoria'])=='Dirección'))){?>
            <input class="campo-dpo" name="dl_rdo_q4_<?php echo $row_lin['dl_id'];?>" value="<?php echo $row_lin['dl_rdo_q4'];?>" />
            <?php }else{ echo $row_lin['dl_rdo_q4'];}$total_q4+=por_obtencion($row_lin['dl_id'],4);?>
			</td>
			<!-- Final -->
          <td class="numerica celdas_subtotal"><?php if($row_lin['ind_mide']==$_SESSION['usr_id'] or ($row_lin['ind_mide']==9999 and ($_SESSION['usr_id']<>$dpo_usr_id or utf8_encode($_SESSION['usr_categoria'])=='Dirección'))){?>
            <input class="campo-dpo" name="dl_rdo_anual_<?php echo $row_lin['dl_id'];?>" value="<?php echo $row_lin['dl_rdo_anual'];?>" />
            <?php }else{ echo $row_lin['dl_rdo_anual'];}$total_anual+=por_obtencion($row_lin['dl_id'],'Anual');?>
			</td>
			<!-- Simulacion final  -->
