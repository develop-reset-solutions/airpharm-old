...
<div id="content">
  <div style="width:100%;">
    <center>
      <form name="desaso" action="imprimir_dpo_todos.php" method="post" style="text-align:-moz-center;">
        <table align="center" width="100%" class="tabla_introduccion">
        <tr>
          <td colspan="2" class="titulo negrita">IMPRIMIR DPO - SELECCIONAR USUARIOS</td>
        </tr>
        <tr>
          <td colspan="2"><table width="100%">
              <tr>
                <td align="center" colspan="4"><select name="usr_id" id="usr_id">
					...
					<optgroup label="Dirección">
						<?php if($_SESSION['usr_perfil']=='Director General' or $_SESSION['usr_perfil']=='Administrador' or $_SESSION['usr_perfil']=='Director RRHH'){
									$query_usr="SELECT * FROM usuarios WHERE usr_baja=0 AND usr_categoria='Direccion' ORDER BY usr_apellidos, usr_nombre ASC";
									$result_usr=mysql_query($query_usr) or die ("No se puede ejecutar la sentencia: ".$query_usr);
									while($row_usr=mysql_fetch_array($result_usr)){
